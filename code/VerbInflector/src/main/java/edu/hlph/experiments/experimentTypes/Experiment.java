...
import edu.hlph.experiments.statisticalTools.Histogram;
import edu.hlph.experiments.features.Feature;
import edu.hlph.experiments.features.UnseenFeature;
...
public abstract class Experiment {
	...
	private List<List<ClassificationSampleIfc>> splitToTrainAndTest(List<ClassificationSampleIfc> samples){
		...
		int trainingNumOfSamples = new Double(new Double(totalNumOfFetures) *this.training).intValue();
